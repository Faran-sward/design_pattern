package SpaceGreenhouse.common.utils;
...
public class JsonOp {
    ...
    public static Map<String, String> searchMapper(String name) {
        try {
            String jsonPath = commonPath + "SpaceGreenhouse/common/resources/mapper.json";
    ...
    public static List<String> SearchJson(ProductType productType) {
        ...
        String jsonPath = commonPath + "SpaceGreenhouse/common/resources/SpaceGreenhouse.json";
        List<String> list = null;
        try {
            JSONObject json = getJson(jsonPath);
            JSONObject temp =json.getJSONObject("SpaceGreenhouse");
    ...
    public static String utilSearchJson(String name, String fileName, String... difference) {
        String jsonPath = commonPath + "SpaceGreenhouse/common/resources/" + fileName + ".json";
    ...
    public static String getMsgJson(String name) {
        return utilSearchJson(name, "msg", "SpaceGreenhouseProductFactory", "IFactory");
    }
